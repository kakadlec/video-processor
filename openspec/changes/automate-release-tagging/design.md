...
**Starting version `0.0.0` in the manifest.** No existing tags. The first merged Release PR will propose `0.1.0` (or higher, depending what commit types land before the first merge) — standard release-please behavior for a fresh repo.
