...
- [x] 1.1 Verify that the propose PR diff contains only files under `openspec/changes/enforce-pr-separation-policy/` (`.openspec.yaml`, `proposal.md`, `design.md`, `tasks.md`, `specs/development-workflow/spec.md`). Confirm no application code, `CLAUDE.md`, CI configuration, or canonical spec files under `openspec/specs/` are modified.
