...
# — Grafana, at http://127.0.0.1:3000, which opens on the provisioned
# pipeline dashboard and needs no login — and Prometheus's UI, at
# http://127.0.0.1:9090, scraping GET /metrics on
