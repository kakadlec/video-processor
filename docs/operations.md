...
|---|---|---|---|
| `IDENTITY_POSTGRES_DSN`, `IDENTITY_JWT_PRIVATE_KEY`, `IDENTITY_JWT_KEY_ID`, `IDENTITY_JWT_PUBLIC_KEYS` | **required** | **not read** — the worker makes no access-control decision | **not read** — same reason |
