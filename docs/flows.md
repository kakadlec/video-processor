...
- **What is still missing:** nothing in Phase 7. Phase 8 (structured logging, metrics, health endpoints) is next and is not yet decomposed — see [docs/roadmap.md](roadmap.md).
